...
import lsst.meas.algorithms.readFitsCatalogTask
config.file_reader.retarget(target=lsst.meas.algorithms.readFitsCatalogTask.ReadFitsCatalogTask, ConfigClass=lsst.meas.algorithms.readFitsCatalogTask.ReadFitsCatalogConfig)# HDU containing the desired binary table, 0-based but a binary table never occurs in HDU 0
