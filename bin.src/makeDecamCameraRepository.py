...
def makeAmpTables(segmentsFile, verbose=False):
    """
    ...
    @param verbose (bool) print status as files are processed.
    """
    returnDict = {}
    ...
    with open(segmentsFile) as fh:
        ...
        for l in fh:
            ...
            if verbose:
                print("Linearity type=%r; coeffs=%s" % (record.getLinearityType(),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--verbose", "-v", action="store_true", help="Print status as files are processed")
    args = parser.parse_args()
    ampTableDict = makeAmpTables(args.SegmentsFile, verbose=args.verbose)
