...
DECAM_FILTER_DEFINITIONS = FilterDefinitionCollection(
    ...
    FilterDefinition(physical_filter="N540 DECam c0014 5403.2 210.0",
                     band="N540"),
    FilterDefinition(physical_filter="N395 DECam c0015 3950.0 100.0",
                     band="N395"),
    FilterDefinition(physical_filter="M411 DECam c0017 4112.0 264.0",
                     band="M411"),
    FilterDefinition(physical_filter="M438 DECam c0019 4380.0 260.0",
                     band="M438"),
    FilterDefinition(physical_filter="M464 DECam c0018 4640.0 264.0",
                     band="M464"),
    FilterDefinition(physical_filter="M490 DECam c0020 4900.0 260.0",
                     band="M490"),
